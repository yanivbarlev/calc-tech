...
// Post-purchase thank-you page for the BRAZILIAN / Portuguese variant
// "Exportar Conversas do WhatsApp" ($4.99). The extension opens this page after the user
// activates a PRO license (free -> Pro). Its job is to fire the Google Ads PURCHASE
// conversion that the side panel cannot — MV3 CSP blocks gtag.js on chrome-extension://
// pages, so the conversion must live on a real origin.
//
// Google Ads conversion action: "WAExportPro Purchase" (shared account for now).
...
<head>
    ...
    <title>Obrigado — Exportar Conversas do WhatsApp PRO</title>
...
<body>
    ...
    <span class="pill">PRO Desbloqueado</span>

    <h1>Obrigado!</h1>
    <p class="sub">Sua licença PRO está ativa. Agora você tem exportações ilimitadas, formatos PDF / CSV / HTML, mídia e listas de contatos e grupos — sem limite de mensagens.</p>

    <a class="cta" href="https://web.whatsapp.com" target="_blank" rel="noopener noreferrer">
        Voltar para o WhatsApp Web
    ...
    <div class="perks">
        <div class="perk"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#2DAA66" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Mensagens ilimitadas — o limite de 100 mensagens acabou</div>
        <div class="perk"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#2DAA66" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Formatos de exportação PDF, CSV, HTML e TXT</div>
        <div class="perk"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#2DAA66" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Exporte fotos, vídeos e áudios</div>
        <div class="perk"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M5 12l5 5L20 7" stroke="#2DAA66" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/></svg>Listas de contatos e participantes de grupos, exportação em massa de várias conversas</div>
    </div>

...
// Post-install page for "WhatsApp Chat Export & Backup" (the $9.95 flagship exporter).
// The extension's service worker opens this URL in a BACKGROUND tab on install
// (WhatsApp Web opens in the foreground). Its job is to fire the Google Ads
// conversion that the bundled chrome-extension:// welcome page cannot — MV3 CSP
// blocks gtag.js on extension pages, so the conversion must live on a real origin.
//
// Google Ads conversion action: "new_whatsapp_extension_michael"
...
<head>
    ...
    <title>You're all set — WhatsApp Chat Export &amp; Backup</title>
...
<body>
    ...
    <p class="sub">WhatsApp Chat Export &amp; Backup is ready. Open WhatsApp Web and click the extension to export any chat as PDF, CSV, or TXT.</p>
    ...
    <div class="steps">
        <div class="step"><span class="n">1</span><span class="txt">Open <strong>web.whatsapp.com</strong> in Chrome and sign in.</span></div>
        <div class="step"><span class="n">2</span><span class="txt">Click the <strong>puzzle-piece icon</strong> in the toolbar and pin the extension.</span></div>
        <div class="step"><span class="n">3</span><span class="txt">Pick a chat, choose a format and date range, then click <strong>Download</strong>.</span></div>
    </div>
